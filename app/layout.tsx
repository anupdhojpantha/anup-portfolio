...
export const metadata: Metadata = {
  ...
  description: "Aspiring Data Analyst from Nepal specializing in Python, SQL, and data visualization tools like Power BI and Tableau. Experienced in data cleaning, statistical analysis, dashboard development, and transforming complex datasets into actionable business insights. Check out my portfolio for projects, skills, and experience.",
  keywords: [
    "Anup Pantha",
"Data Analyst",
"Junior Data Analyst",
...
export default function RootLayout({
  ...
  const jsonLd = {
    ...
    description: 'Aspiring Data Analyst specializing in extracting insights from data through analysis, visualization, and statistical methods.',
    knowsAbout: [
  'Python',
  'SQL',
  'Data Analysis',
